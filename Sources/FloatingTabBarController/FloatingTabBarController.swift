...
extension FloatingTabBarController {
    ...
    private func setConfigModel() {
        ...
        let configModel = ConfigModel(
            ...
            ipadBottomSpacing: iPadBottomSpacing,
            horizontalSpacing: horizontalSpacing,
            ipadHorizontalSpacing: iPadHorizontalSpacing,
            innerHorizontalSpacing: innerHorizontalSpacing,
            iPadInnerHorizontalSpacing: iPadInnerHorizontalSpacing,
            itemSpacing: itemSpacing,
            positioning: positioning,
            minimumItemWidth: minimumItemWidth,
            cornerRadius: cornerRadius,
            iPadCornerRadius: iPadCornerRadius,
